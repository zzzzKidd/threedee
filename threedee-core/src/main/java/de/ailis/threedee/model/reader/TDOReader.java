 ...
 *
 * Fileformat of a TDO file:
 *
 * <pre>
 * char[3] header; // The file header. Must be "TDO"
...
public class TDOReader extends ModelReader
{
    ...
    public TDOReader(final ResourceProvider resourceProvider)
    {
    ...
    /**
     * Reads and checks the TDO header. Throws an exception if file is not
     * a TDO file.
     *
     * @throws IOException
     *             When header could not be read or file is not a TDO
     *             file
     */
    ...
    /**
     * Reads and checks the version of the TDO file.
     *
     * @throws IOException

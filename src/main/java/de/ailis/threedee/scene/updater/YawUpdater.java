...
public class YawUpdater implements NodeUpdater
{
    ...
    /**
     * Constructs a new yaw updater with the specified angle.
     * 
     * @param angle
    ...
    public YawUpdater(final double angle)
    {
        setAngle(angle);
    }
    ...
    public void update(final SceneNode node, final long delta)
    {
        ...
        node.rotateY(this.angle * delta / 1000000000);
    }
     ...
     * 
     * @return The angle the node is rotated around the Y axis per second.

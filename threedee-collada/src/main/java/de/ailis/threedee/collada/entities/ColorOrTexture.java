...
public class ColorOrTexture implements Serializable
{
    /** Serial version UID */
    private static final long serialVersionUID = 1L;

    /** The opaque information */
    ...
    /**
     * Sets the opaque information.
     *
     * @param opaque
     *            The opaque information to set or null for unspecified
     */
    ...
    /**
     * Returns the opaque information.
     *
     * @return The opaque information or null if not specified
     */
    ...
    public ColorOrTexture(final ColladaTexture texture)
    {
        setTexture(texture);
    }
    ...
    public void setTexture(final ColladaTexture texture)
    {
        if (texture == null)

...
/**
 * Displays the COLLADA File Path Test scene.
 *
...
public class FilePathTest
{
    ...
    {
        // Load the scene
        final String filename = "/file_path_test/FilePathTest.dae";
        ...
        camera.rotateX((float) Math.toRadians(-90));
        camera.translateZ(200f);
